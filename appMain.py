...
from appGUI.PanelStyles import apply_modern_main_workspace_style, apply_modern_panel_style
...
class App(QtCore.QObject):
    ...
    def __init__(self, qapp, user_defaults=True, startup_project_request=None):
        ...
        apply_modern_main_workspace_style(self.ui, self)
    ...
    def connect_tools_signals_to_toolbar(self):
        ...
        if hasattr(self.ui, "ai_settings_btn"):
            self.ui.ai_settings_btn.triggered.connect(self.ai_assistant_tool.open_settings_dialog)
    ...
    def on_about(self):
        ...
        class AboutDialog(QtWidgets.QDialog):
            ...
            def __init__(self, app, parent):
                ...
                self.prog_grid_lay.addWidget(FCLabel('%s' % _("Original FlatCAM Maintainer")), 3, 1)
    ...
    def on_move2origin(self, use_thread=True):
        """
        Move selected objects to canvas origin using their lower-left corner as reference.
                ...
                for obj in obj_list:
                    ...
                    if obj.kind == 'gerber':
                        ...
                        obj.source_file = self.f_handlers.export_dxf(
                            obj_name=out_name, filename=None, local_use=obj, use_thread=False)
                self.inform.emit('[success] %s...' % _('Selection moved to origin'))
    ...
    def setup_default_properties_tab(self):
        ...
        apply_modern_panel_style(d_properties_tw, self)
